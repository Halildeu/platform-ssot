...
Platform dokümanlarının yazım, review, yayınlama ve güncel tutma sürecini standartlaştırmak.

## 2. KAPSAM

- Tüm `docs/` altındaki Markdown dokümanlar (PB, PRD, STORY, AC, TP, GUIDE, RUNBOOK, ADR, SPEC vb.)
- Şablon kullanımı, metadata yönetimi, CODEOWNERS review akışı
- Permission registry guardrail'i ve CI entegrasyonu

## 3. KAPSAM DIŞI

- Kod yorumları ve inline dokümantasyon (bkz. coding standards)
- API doküman üretimi (OpenAPI/Swagger otomatik üretim pipeline'ı)

## 4. BAĞLAM / ARKA PLAN

- Doküman kategorileri `DOCS-PROJECT-LAYOUT.md` içinde listelenmiştir.
...
### 5.3 Permission Registry Guardrail'i
...
- Proje akışı: `docs/03-delivery/PROJECT-FLOW.md`
- Araçlar:
