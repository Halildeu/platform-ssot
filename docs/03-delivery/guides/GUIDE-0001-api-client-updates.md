...
İstemcilerin (FE, Postman, 3rd-party) yeni güvenlik ve başlık sözleşmelerine uyumlu şekilde API çağrılarını güncellemesi.

## 2. KAPSAM

- Web shell, mobil uygulama ve 3rd-party istemciler
- Login, kullanıcı CRUD, korumalı listeleme, export guard akışları
- Gateway üzerinden `/api/*` endpoint'leri

## 3. KAPSAM DIŞI

- Backend servis implementasyonları (auth-service, permission-service iç detayları)
- Keycloak yönetim konsolu ayarları (bkz. `RB-keycloak.md`)
...
- İzleme/uyarılar: `docs/04-operations/RUNBOOKS/RB-feature-flags.md`

### 5.6 Postman / Environment Önerisi
...
### 5.7 Geriye Dönük Uyum ve Versiyonlama
