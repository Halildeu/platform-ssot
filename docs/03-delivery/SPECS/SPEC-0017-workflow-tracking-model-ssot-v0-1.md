...
### Deploy Lifecycle (SSOT = chain log index)
...
### Failure Taxonomy → Aksiyon Haritası (Özet)
...
- Breaking model değişiklikleri yeni SPEC versiyonu ile yapılır.
