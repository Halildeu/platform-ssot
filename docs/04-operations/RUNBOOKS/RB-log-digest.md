...
- Local SSOT policy (Mandatory): Fix/patch işlemleri yalnızca localde yapılır (bkz. docs/04-operations/RUNBOOKS/RB-insansiz-flow.md → “Local SSOT Policy (Mandatory)”).
