...
def main() -> int:
    ...
    expected_presets = {
        "ui-library": ("playwright:ui_library_page|ui_library_navigation_walk|ui_library_foundation_wave_1_walk|ui_library_navigation_wave_2_walk|ui_library_forms_wave_3_walk", "gateway_smoke", "base_url_fetch_check"),
        "shell-public": ("playwright:shell_login|runtime_theme_matrix|ui_library_page|ui_library_navigation_walk|ui_library_navigation_wave_2_walk|ui_library_forms_wave_3_walk|shell_public_route_walk", "gateway_smoke", "base_url_fetch_check"),
