...
export const hrCompensationModule: ReportModule<HrCompensationFilters, HrCompensationRow> = {
  ...
  getColumnMeta: (): ColumnMeta[] => [
    ...
    { field: 'GROSS_SALARY', headerNameKey: 'reports.hrCompensation.columns.grossSalary', columnType: 'currency', currencyCode: 'TRY', width: 120 },
    { field: 'NET_SALARY', headerNameKey: 'reports.hrCompensation.columns.netSalary', columnType: 'currency', currencyCode: 'TRY', width: 120 },
    { field: 'TOTAL_EMPLOYER_COST', headerNameKey: 'reports.hrCompensation.columns.employerCost', columnType: 'currency', currencyCode: 'TRY', width: 130 },
    { field: 'SSK_EMPLOYER', headerNameKey: 'reports.hrCompensation.columns.sskEmployer', columnType: 'currency', currencyCode: 'TRY', width: 110 },
    { field: 'INCOME_TAX', headerNameKey: 'reports.hrCompensation.columns.incomeTax', columnType: 'currency', currencyCode: 'TRY', width: 110 },
    { field: 'OVERTIME_PAY', headerNameKey: 'reports.hrCompensation.columns.overtime', columnType: 'currency', currencyCode: 'TRY', width: 100 },
    { field: 'SEVERANCE_AMOUNT', headerNameKey: 'reports.hrCompensation.columns.severance', columnType: 'currency', currencyCode: 'TRY', width: 120 },
    {
