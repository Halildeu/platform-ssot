...
const InlineJsonViewer: React.FC<InlineJsonViewerProps> = ({
  ...
  <div>
    ...
    <pre className="overflow-auto rounded-surface bg-surface-muted p-4 text-xs leading-relaxed text-text-primary">
