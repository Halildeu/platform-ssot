  ...
  render: (args) => (
    <FieldControlShell {...args}>
      <input
        ...
        type="text"
        placeholder="johndoe"
        className="w-full rounded-control border px-3 py-2"
      />
    </FieldControlShell>
  ),
};
  ...
  render: (args) => (
    <FieldControlShell {...args}>
      <input
        ...
        className="w-full rounded-control border border-state-danger-text px-3 py-2"
      />
    </FieldControlShell>
  ),
};
  ...
  render: (args) => (
    <FieldControlShell {...args}>
      <input
        ...
        disabled
        className="w-full rounded-control border px-3 py-2 opacity-50"
      />
    </FieldControlShell>
  ),
};
