  ...
  (
    ...
    return (
      ...
      >
        ...
        <span
          className={cn(
            "relative inline-flex shrink-0 rounded-full transition-colors duration-motion-medium",
        ...
        >
          <span
            className={cn(
              "pointer-events-none inline-flex items-center justify-center rounded-full bg-surface-default shadow-elevation-sm transition-[translate] duration-motion-medium",
