  ...
  return (
    ...
    >
      ...
      <img
        ...
        className="max-h-[90vh] max-w-[90vw] cursor-zoom-in object-contain transition-transform duration-motion-medium"
      />
    </div>
  );
};
        ...
        >
          ...
          {inView && resolvedSrc && (
            <img
              ...
              className={cn(
                'h-full w-full transition-opacity duration-motion-medium',
