    ...
    return (
      <label
        ...
        className={cn(
          ...
          isCard && "rounded-surface border px-3 py-2.5 transition-colors duration-motion-fast",
          isCard &&
            (checked
      ...
      >
        <span className="relative mt-0.5 flex items-center justify-center">
          ...
          <span
            className={cn(
              "flex items-center justify-center rounded-control border-2 transition-colors duration-motion-fast",
