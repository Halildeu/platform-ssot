    ...
    <div data-component="gallery-group" data-group={name}>
      ...
      <button
        ...
        className={cn(
          ...
          "text-start transition-colors duration-motion-fast",
      ...
      >
        ...
        <svg
          className={cn(
            "h-4 w-4 shrink-0 text-text-secondary transition-transform duration-motion-medium",
            expanded && "rotate-90",
          )}
          viewBox="0 0 16 16"
          fill="none"
      ...
      <div
        ref={contentRef}
        className="overflow-hidden transition-[max-height] duration-motion-medium ease-in-out"
        style={{
