  ...
  return (
    <div ref={ref} className={cn('bg-surface-default border-b border-border-subtle py-1 text-text-primary', className)} role="group" aria-label={label}>
        ...
        {collapsible ? (
          <button
            ...
            className={cn(
              ...
              'transition-colors duration-motion-medium outline-hidden',
          ...
          >
            ...
            <svg
              className={cn(
                'h-3.5 w-3.5 shrink-0 transition-transform duration-motion-medium',
                !open && '-rotate-90',
              )}
              viewBox="0 0 12 12"
              fill="currentColor"
      ...
      <div
        ref={contentRef}
        className={cn(
          'overflow-hidden transition-[max-height,opacity] duration-motion-medium ease-in-out',
